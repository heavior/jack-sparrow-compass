...
<figure>
	...
	<figcaption>
		Finally, to complete the experience, I added a leather lace with some braiding, aged brass carabiner from Aliexpress, and sailors knot to close the loop. This allows comfortable wearing around the neck as well as on the belt.
	</figcaption>
</figure> 
