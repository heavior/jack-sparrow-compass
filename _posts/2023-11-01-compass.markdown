...
{% comment %}
TODO: Photos the compass iterations ???
{% endcomment %}
...
{% comment %}
TODO: Photo of spare dome - inside and out
{% endcomment %}
...
{% comment %}
TODO: Photo of sundial cutting (old)
{% endcomment %}
...
{% comment %}
TODO: Photo of glowing dial, maybe video
{% endcomment %}
...
<figure>
	...
	<figcaption>
		Finally, to complete the experience, I added a leather lace with some braiding, aged brass carabiner from Aliexpress, and sailors know to close the loop. This allows comfortable wearing around the neck as well as on the belt.
	</figcaption>
</figure> 
...
{% comment %}
TODO: Photo of 3D mount iterations
{% endcomment %}
